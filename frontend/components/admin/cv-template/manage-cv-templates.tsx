    ...
    <div className="flex-1 space-y-6 p-6 pt-0 bg-gray-50">
          ...
          <DialogContent className="sm:max-w-[500px]">
            ...
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                <Label htmlFor="templateName">
                  {t.admin.cvTemplate.dialog.templateName}
                </Label>
                <Input
                  id="templateName"
                  placeholder={t.admin.cvTemplate.dialog.enterName}
                />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="category">
                  {t.admin.cvTemplate.dialog.category}
                </Label>
                <Select>
                  <SelectTrigger>
                    <SelectValue
                      placeholder={t.admin.cvTemplate.dialog.selectCategory}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="professional">
                      {t.admin.cvTemplate.categories.professional}
                    </SelectItem>
                    <SelectItem value="creative">
                      {t.admin.cvTemplate.categories.creative}
                    </SelectItem>
                    <SelectItem value="minimalist">
                      {t.admin.cvTemplate.categories.minimalist}
                    </SelectItem>
                    <SelectItem value="modern">
                      {t.admin.cvTemplate.categories.modern}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="grid gap-2">
                <Label htmlFor="description">
                  {t.admin.cvTemplate.dialog.description}
                </Label>
                <Textarea
                  id="description"
                  placeholder={t.admin.cvTemplate.dialog.enterDesc}
                />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="status">
                  {t.admin.cvTemplate.dialog.status}
                </Label>
                <Select>
                  <SelectTrigger>
                    <SelectValue
                      placeholder={t.admin.cvTemplate.dialog.selectStatus}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    ...
                    <SelectItem value="draft">
                      {t.admin.cvTemplate.status.draft}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={() => setIsCreateDialogOpen(false)}>
                {t.admin.cvTemplate.dialog.create}
              </Button>
            </div>
          </DialogContent>
        </Dialog>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>
              {t.admin.cvTemplate.title} ({filteredTemplates.length})
            </CardTitle>
            ...
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">
                  {t.admin.cvTemplate.table.actions}
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredTemplates.map((template) => (
                <TableRow key={template._id}>
                  ...
                  <TableCell>
                    <Badge className={getCategoryColor("Professional")}>
                      {t.admin.cvTemplate.categories.professional}
                    </Badge>
                  </TableCell>
                  <TableCell>
