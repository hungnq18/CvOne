...
export function ManageUsers() {
  ...
  const validateForm = (): boolean => {
    ...
    if (
      ...
      !formData.email.trim().endsWith(INTERNAL_EMAIL_DOMAIN)
    ) {
      showErrorToast(
        "Validation Error",
    ...
    try {
      if (isEditMode && selectedUser) {
        ...
        if (
          ...
          formData.role !== selectedUser.account_id.role
        ) {
    ...
    <div className="flex-1 space-y-6 p-6 pt-0 bg-gray-50">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>
              {t.admin.manageUser.table.users} ({filteredUsers.length})
            </CardTitle>
        ...
        <CardContent className="flex flex-col min-h-[420px]">
              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right">
                    {t.admin.manageUser.table.actions}
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {paginatedUsers.map((user) => {
                  ...
                  return (
                    <TableRow key={user._id}>
                      ...
                      <TableCell>
                        <Badge className={getRoleColor(user.account_id.role)}>
                          {user.account_id.role}
                        </Badge>
                      </TableCell>
                      <TableCell>{user.account_id.email}</TableCell>
          ...
          <div className="mt-4 flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              ...
              {t.admin.manageUser.table.of} {filteredUsers.length}{" "}
              {t.admin.manageUser.table.users}
            </p>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>
              {isEditMode
                ? t.admin.manageUser.dialog.editTitle
                : t.admin.manageUser.dialog.addTitle}
            </DialogTitle>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="first_name">
                  {t.admin.manageUser.dialog.firstName}
                </Label>
                <Input
                  id="first_name"
              ...
              <div>
                <Label htmlFor="last_name">
                  {t.admin.manageUser.dialog.lastName}
                </Label>
                <Input
                  id="last_name"
            ...
            <div className="grid gap-2">
              <Label htmlFor="email">
                {t.admin.manageUser.dialog.email}{" "}
            ...
            {!isEditMode && (
              <div className="grid gap-2">
                <Label htmlFor="password">
                  {t.admin.manageUser.dialog.password}{" "}
                  <span className="text-red-500">*</span>
                </Label>
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="role">
                  {t.admin.manageUser.dialog.role}{" "}
                  <span className="text-red-500">*</span>
                </Label>
                <Select
                  value={formData.role}
                ...
                >
                  <SelectTrigger>
                    <SelectValue
                      placeholder={t.admin.manageUser.dialog.selectRole}
                    />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                >
                  <SelectTrigger>
                    <SelectValue
                      placeholder={
                        loading ? "Loading..." : "Select city/province"
                      }
                    />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                <Label htmlFor="district">
                  {t.admin.manageUser.dialog.district}
                </Label>
                <Select
          ...
          <DialogFooter>
            ...
            <Button type="button" onClick={handleSaveUser}>
              {t.admin.manageUser.dialog.save}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
