            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden w-full h-[200px] flex flex-col justify-between">
                ...
                <div className="p-2 flex-1 flex flex-col justify-between">
                    <div>
                        ...
                        <p className="text-xs text-gray-600 line-clamp-1">{job.role}</p>
                    </div>
                    <div className="text-xs text-gray-500 mt-1">
                        <span>{job.location}</span> | <span>{job.salaryRange}</span>
                    </div>
                    <div className="flex justify-between items-center mt-2">
                        <span className="text-white text-xs px-2 py-1 rounded bg-gray-500">
                            Xem chi tiết
                        </span>
