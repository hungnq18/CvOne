...
const ModernCV1: React.FC<ModernCV1Props> = ({
  ...
  // Tách danh sách section ra theo cột (place)
  ...
  // --- Hàm render cho từng section ---
  const renderSection = (sectionId: string) => {
    switch (sectionId) {
      case "avatar":
        return (
          <div className="px-8 lg:px-12" key="avatar">
                  ...
                  return (
                    <div key={i} className="group">
                      <div className="flex items-start justify-between gap-6 mb-3 text-white-600 group-hover:text-teal-200">
                        ...
                        <span className="text-2xl font-normal whitespace-nowrap flex-shrink-0">
                          {rating}/5
                        </span>
                      </div>
