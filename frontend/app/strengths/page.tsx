...
const strengthsTranslations = {
  en: {
    heading: "Choose your top 3 strengths.",
    subheading:
  ...
  vi: {
    heading: "Chọn 3 điểm mạnh hàng đầu của bạn.",
    subheading:
      "Chúng tôi sẽ làm nổi bật chúng trong thư xin việc để phù hợp với vị trí mong muốn.",
...
function StrengthsContent() {
  ...
  const t = strengthsTranslations[language];
  const fullStrengths = strengthsList[language];
  ...
  const remainingStrengths = fullStrengths.filter(
    (strength) => !selectedStrengths.includes(strength)
  );
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center py-12 px-4 mt-16">
      <div className="w-full max-w-4xl flex flex-col items-center">
        ...
        <p className="text-gray-500 mb-10 text-center">{t.subheading}</p>
